...
# with command line options: Configuration/GenProduction/python/BsTof0MM_f0ToKK_2018.py --python_filename BsTof0MM_f0ToKK_2018_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN --fileout file:BsTof0MM_f0ToKK_2018.root --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 10000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BsTof0MM_f0ToKK_2018.py nevts:10000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:BsTof0MM_f0ToKK_2018.root'),
...
process.f0filter = cms.EDFilter("PythiaDauVFilter",
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.bfilter+process.decayfilter+process.f0filter)
